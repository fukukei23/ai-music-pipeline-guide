#!/usr/bin/env python3
"""AI音楽パイプラインガイド: Markdown → モバイル最適化HTML変換スクリプト."""
...
# 既存章の手動定義
CHAPTER_MAP = {
    "00_概要.md": {"slug": "00-overview", "title": "概要", "icon": "🎵", "desc": "AI音楽パイプラインの全体像・4スキルの位置づけ・定性vs定量"},
    "01_make-song.md": {"slug": "01-make-song", "title": "make-song", "icon": "🎼", "desc": "汎用作曲エンジン・曲先サビ淘汰型・MiniMax music-2.6"},
    "02_reverse-engineer-song.md": {"slug": "02-reverse-engineer-song", "title": "reverse-engineer-song", "icon": "🔬", "desc": "既存曲の定性RE・Gemini API・3モダリティのプロンプト仕様書"},
    "03_analyze-song.md": {"slug": "03-analyze-song", "title": "analyze-song", "icon": "📊", "desc": "楽曲定量分析・BPM/キー/コード/phrase_repetition・Phase1a"},
    "04_video-prompt-spec.md": {"slug": "04-video-prompt-spec", "title": "video-prompt-spec", "icon": "🎬", "desc": "映像プロンプト仕様書・4構造・音源→映像"},
    "05_連携フロー.md": {"slug": "05-pipeline", "title": "連携フロー", "icon": "🔗", "desc": "4スキルの組み合わせ・実例（yoen-night）"},
    "06_使い分け判断木.md": {"slug": "06-decision-tree", "title": "使い分け判断木", "icon": "🌳", "desc": "目的別スキル選択チャート"},
}
...
<head>
    ...
    <title>{{ title }} — AI音楽パイプラインガイド</title>
    <meta name="description" content="AI音楽パイプラインガイド — {{ title }}">
    <meta property="og:title" content="{{ title }} — AI音楽パイプラインガイド">
    <meta property="og:description" content="AI音楽パイプラインガイド {{ title }}">
    <meta property="og:type" content="article">
    <meta property="og:url" content="https://fukukei23.github.io/ai-music-pipeline-guide/chapters/{{ slug }}.html">
    <meta property="og:image" content="https://fukukei23.github.io/ai-music-pipeline-guide/assets/ogp.png">
...
<body>
    <header class="site-header">
        ...
        <a href="../index.html" class="site-title">🎵 AI音楽パイプラインガイド</a>
    ...
    <footer class="site-footer">
        <p>AI音楽パイプラインガイド — <a href="https://github.com/fukukei23/ai-music-pipeline-guide">GitHub</a>
         · <a href="https://fukukei23.github.io/make-song-guide/">make-song Guide</a>
...
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>AI音楽制作パイプラインガイド</title>
    <meta name="description" content="作曲・分析・映像化を4スキル連携でつなぐAI音楽制作パイプラインの実践ガイド">
    <meta property="og:title" content="AI音楽制作パイプラインガイド">
    <meta property="og:description" content="作曲・分析・映像化を4スキル連携でつなぐAI音楽制作パイプラインの実践ガイド">
    <meta property="og:type" content="website">
    <meta property="og:url" content="https://fukukei23.github.io/ai-music-pipeline-guide/">
    <meta property="og:image" content="https://fukukei23.github.io/ai-music-pipeline-guide/assets/ogp.png">
    <meta name="twitter:card" content="summary_large_image">
    <link rel="stylesheet" href="assets/style.css">
    <link rel="icon" href="data:image/svg+xml,<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 100 100'><text y='.9em' font-size='90'>⚡</text></svg>">
...
<body class="index-page">
    <header class="site-header">
        <span class="site-title">🎵 AI音楽パイプラインガイド</span>
        <button class="theme-toggle" id="themeToggle" aria-label="テーマ切替">
            <span class="icon-light">☀️</span>
            <span class="icon-dark">🌙</span>
        </button>
        ...
        <section class="features">
            ...
            <div class="feature-grid">
                <div class="feature-item">
                    ...
                    <h3>設計哲学から</h3>
                    <p>作曲から映像化まで、4つのAIスキルを連携させる実践ガイド</p>
                </div>
                <div class="feature-item">
                    <span class="feature-icon">🤖</span>
                    <h3>AI協働特化</h3>
                    <p>make-song/analyze-song等のAI音楽スキルを連携させる実践設計</p>
                </div>
                <div class="feature-item">
                    <span class="feature-icon">📱</span>
                    <h3>モバイル対応</h3>
...
def filter_sections(text: str) -> str:
    ...
    # 個人識別子のサニタイズ（ai-music-pipeline-guideはパブリック公開コンテンツのため不要）
    pass
